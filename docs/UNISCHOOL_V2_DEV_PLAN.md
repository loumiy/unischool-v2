...
- **After 1.0:** the release playtest (`docs/reviews/release-playtest/REVIEW.md`) produced `docs/UNISCHOOL_V2_DEV_PLAN_1_1.md`, Phases 35–52: keeping the middle years hard, the first hour finished, goals for the middle, builds that diverge, and a visual refinement pass.
